 ...
 */
package org.jkiss.dbeaver.ext.gbase8a.ui.internal;

import org.eclipse.osgi.util.NLS;

public final class GBase8aUIMessages extends NLS {
    private static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.gbase8a.ui.internal.GBase8aUIMessages"; //$NON-NLS-1$

    static {
        // initialize resource bundle
        NLS.initializeMessages(BUNDLE_NAME, GBase8aUIMessages.class);
    }
    ...
    public static String gbase8a_ssl_configurator_checkbox_allow_public_key;
    public static String gbase8a_ssl_configurator_checkbox_require_ssl;
    public static String gbase8a_ssl_configurator_checkbox_verify_server_certificate;
    public static String gbase8a_ssl_configurator_checkbox_allow_public_key_tip;
    public static String gbase8a_ssl_configurator_label_ca_certificate;
    public static String gbase8a_ssl_configurator_label_cipher_suites;
    public static String gbase8a_ssl_configurator_label_cipher_suites_tip;
    public static String gbase8a_ssl_configurator_checkbox_require_ssl_tip;
    public static String gbase8a_ssl_configurator_checkbox_verify_server_certificate_tip;
    public static String gbase8a_ssl_configurator_legend_advanced;
