...
public class GBase8aModifyResourcePlanDialog extends BaseDialog {
    private final GBase8aDataSource dataSource;
    private String name;
    private String comment;
    private final String vcName;
    private String original_name;
    private final GBase8aResourcePlan resourcePlan;

    public GBase8aModifyResourcePlanDialog(Shell parentShell, GBase8aDataSource dataSource, GBase8aResourcePlan group, String vcName) {
        super(parentShell, GBase8aMessages.dialog_modify_resource_plan_dialog_name, null);
        this.dataSource = dataSource;
        this.vcName = vcName;
        this.resourcePlan = group;
    }
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        nameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                GBase8aModifyResourcePlanDialog.this.name = nameText.getText();
            }
        });

        nameText.setText(this.resourcePlan.getName());
        ...
        commentText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                GBase8aModifyResourcePlanDialog.this.comment = commentText.getText();
            }
        });

        if (this.resourcePlan.getComment() != null) {
            commentText.setText(this.resourcePlan.getComment());
        }
        this.original_name = this.resourcePlan.getName();
