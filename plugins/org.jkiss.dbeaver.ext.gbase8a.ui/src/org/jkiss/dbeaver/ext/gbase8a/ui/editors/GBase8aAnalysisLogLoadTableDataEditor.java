...
//
//
//public class GBase8aAnalysisLogLoadTableDataEditor extends SinglePageDatabaseEditor<IDatabaseEditorInput> {
...
//                LogAnalysis.setConnection(GBase8aAnalysisLogLoadTableDataEditor.this.conn);
//                GBase8aAnalysisLogLoadTableDataEditor.this.qim = new QueryItemManager();
//                GBase8aAnalysisLogLoadTableDataEditor.this.qim.setStartTime(GBase8aAnalysisLogLoadTableDataEditor.this.cdtStartTime.getText());
//                GBase8aAnalysisLogLoadTableDataEditor.this.qim.setEndTime(GBase8aAnalysisLogLoadTableDataEditor.this.cdtEndTime.getText());
//                GBase8aAnalysisLogLoadTableDataEditor.this.qim.setUserName(GBase8aAnalysisLogLoadTableDataEditor.this.comboUser.getText());
//                GBase8aAnalysisLogLoadTableDataEditor.this.qim.setTop(GBase8aAnalysisLogLoadTableDataEditor.this.txtTop.getText());
//                if (LogAnalysis.checkedDate(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogLoadTableDataEditor.this.qim) && LogAnalysis.checkTop(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogLoadTableDataEditor.this.qim)) {
...
//                        return;
//                    }
//                    GBase8aAnalysisLogLoadTableDataEditor.this.refreshTable(GBase8aAnalysisLogLoadTableDataEditor.this.getMap_table());
//                }
//            }
//        });
//
...
//            public void widgetSelected(SelectionEvent e) {
//                LogAnalysis.export(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogLoadTableDataEditor.this.table.getColumns(), GBase8aAnalysisLogLoadTableDataEditor.this.table.getItems());
//            }
//        });
//
...
//                TableItem[] items = GBase8aAnalysisLogLoadTableDataEditor.this.table.getItems();
//                Point pt = new Point(e.x, e.y);
//                StringBuffer sb = new StringBuffer();
//                for (int i = 0; i < items.length; i++) {
//                    for (int j = 0; j < GBase8aAnalysisLogLoadTableDataEditor.this.table.getColumnCount(); j++) {
...
//                                sb.append(itemtext);
//                            }
//                            GBase8aAnalysisLogLoadTableDataEditor.this.table.setToolTipText(sb.toString());
//                        }
//                    }
//                }
//            }
...
//        public void run() {
//            try {
//                GBase8aAnalysisLogLoadTableDataEditor.this.setMap_table(LogAnalysis.getUserLoadMaxData(GBase8aAnalysisLogLoadTableDataEditor.this.qim));
...
//
//
///* Location:              /data/yolo/GBaseDataStudio_9.5.2.0_build21_Windows_x86_64/GBaseDataStudio/plugins/cn.gbase.studio.ext.gbase8a_1.0.0.jar!/cn/gbase/studio/ext/gbase8a/editors/GBase8aAnalysisLogLoadTableDataEditor.class
