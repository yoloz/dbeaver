...
//
//
//public class GBase8aPerformanceMaxLongTimeSQLEditor extends SinglePageDatabaseEditor<IDatabaseEditorInput> {
...
//                LogAnalysis.setConnection(GBase8aPerformanceMaxLongTimeSQLEditor.this.conn);
//                GBase8aPerformanceMaxLongTimeSQLEditor.this.qim = new QueryItemManager();
//                GBase8aPerformanceMaxLongTimeSQLEditor.this.qim.setStartTime(GBase8aPerformanceMaxLongTimeSQLEditor.this.cdtStartTime.getText());
//                GBase8aPerformanceMaxLongTimeSQLEditor.this.qim.setEndTime(GBase8aPerformanceMaxLongTimeSQLEditor.this.cdtEndTime.getText());
//                if (LogAnalysis.checkedDate(Display.getCurrent().getActiveShell(), GBase8aPerformanceMaxLongTimeSQLEditor.this.qim)) {
...
//                        return;
//                    }
//                    GBase8aPerformanceMaxLongTimeSQLEditor.this.refreshTable(GBase8aPerformanceMaxLongTimeSQLEditor.this.getMap_sql());
//                }
//            }
//        });
//
...
//            public void widgetSelected(SelectionEvent e) {
//                LogAnalysis.export(Display.getCurrent().getActiveShell(), GBase8aPerformanceMaxLongTimeSQLEditor.this.table.getColumns(), GBase8aPerformanceMaxLongTimeSQLEditor.this.table.getItems());
//            }
//        });
//
...
//                TableItem[] items = GBase8aPerformanceMaxLongTimeSQLEditor.this.table.getItems();
//                Point pt = new Point(e.x, e.y);
//                StringBuffer sb = new StringBuffer();
//                for (int i = 0; i < items.length; i++) {
//                    for (int j = 0; j < GBase8aPerformanceMaxLongTimeSQLEditor.this.table.getColumnCount(); j++) {
...
//                                sb.append(itemtext);
//                            }
//                            GBase8aPerformanceMaxLongTimeSQLEditor.this.table.setToolTipText(sb.toString());
//                        }
//                    }
//                }
//            }
...
//        public void run() {
//            try {
//                GBase8aPerformanceMaxLongTimeSQLEditor.this.setMap_sql(LogAnalysis.getPerformanceMaxLongTimeSQL(GBase8aPerformanceMaxLongTimeSQLEditor.this.qim));
...
//
//
///* Location:              /data/yolo/GBaseDataStudio_9.5.2.0_build21_Windows_x86_64/GBaseDataStudio/plugins/cn.gbase.studio.ext.gbase8a_1.0.0.jar!/cn/gbase/studio/ext/gbase8a/editors/GBase8aPerformanceMaxLongTimeSQLEditor.class
