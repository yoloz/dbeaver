 ...
 */
public class GBase8aSSLConfigurator extends SSLConfiguratorTrustStoreUI {
    ...
    public void createControl(@NotNull Composite parent, Object object, @NotNull Runnable propertyChangeListener) {
        ...
        {
            cipherSuitesText = UIUtils.createLabelText(sslCertComposite, GBase8aUIMessages.gbase8a_ssl_configurator_label_cipher_suites, ""); //$NON-NLS-2$
            cipherSuitesText.setToolTipText(GBase8aUIMessages.gbase8a_ssl_configurator_label_cipher_suites_tip);
        }
    ...
    public void loadSettings(@NotNull DBWHandlerConfiguration configuration) {
        ...
        if (CommonUtils.isEmpty(configuration.getStringProperty(SSLHandlerTrustStoreImpl.PROP_SSL_METHOD))) {
            ...
            caCertPath.setText(CommonUtils.notEmpty(configuration.getStringProperty(GBase8aConstants.PROP_SSL_CA_CERT)));
            clientCertPath.setText(CommonUtils.notEmpty(configuration.getStringProperty(GBase8aConstants.PROP_SSL_CLIENT_CERT)));
            clientKeyPath.setText(CommonUtils.notEmpty(configuration.getStringProperty(GBase8aConstants.PROP_SSL_CLIENT_KEY)));
        }

        requireSSQL.setSelection(configuration.getBooleanProperty(GBase8aConstants.PROP_REQUIRE_SSL, false));
        veryServerCert.setSelection(configuration.getBooleanProperty(GBase8aConstants.PROP_VERIFY_SERVER_SERT, true));
        allowPublicKeyRetrieval.setSelection(configuration.getBooleanProperty(GBase8aConstants.PROP_SSL_PUBLIC_KEY_RETRIEVE, false));

        cipherSuitesText.setText(CommonUtils.notEmpty(configuration.getStringProperty(GBase8aConstants.PROP_SSL_CIPHER_SUITES)));
    }
    ...
    public void saveSettings(@NotNull DBWHandlerConfiguration configuration) {
        ...
        configuration.setProperty(GBase8aConstants.PROP_REQUIRE_SSL, String.valueOf(requireSSQL.getSelection()));
        configuration.setProperty(GBase8aConstants.PROP_VERIFY_SERVER_SERT, String.valueOf(veryServerCert.getSelection()));
        configuration.setProperty(GBase8aConstants.PROP_SSL_PUBLIC_KEY_RETRIEVE, String.valueOf(allowPublicKeyRetrieval.getSelection()));
        configuration.setProperty(GBase8aConstants.PROP_SSL_CIPHER_SUITES, cipherSuitesText.getText());
    }
}
