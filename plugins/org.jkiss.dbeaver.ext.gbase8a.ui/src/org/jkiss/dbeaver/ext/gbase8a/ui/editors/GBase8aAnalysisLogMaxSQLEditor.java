...
//
//
//public class GBase8aAnalysisLogMaxSQLEditor extends SinglePageDatabaseEditor<IDatabaseEditorInput> {
...
//                LogAnalysis.setConnection(GBase8aAnalysisLogMaxSQLEditor.this.conn);
//                GBase8aAnalysisLogMaxSQLEditor.this.qim = new QueryItemManager();
//                GBase8aAnalysisLogMaxSQLEditor.this.qim.setStartTime(GBase8aAnalysisLogMaxSQLEditor.this.cdtStartTime.getText());
//                GBase8aAnalysisLogMaxSQLEditor.this.qim.setEndTime(GBase8aAnalysisLogMaxSQLEditor.this.cdtEndTime.getText());
//                GBase8aAnalysisLogMaxSQLEditor.this.qim.setUserName(GBase8aAnalysisLogMaxSQLEditor.this.comboUser.getText());
//                GBase8aAnalysisLogMaxSQLEditor.this.qim.setTop(GBase8aAnalysisLogMaxSQLEditor.this.txtTop.getText());
//                if (LogAnalysis.checkedDate(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogMaxSQLEditor.this.qim) && LogAnalysis.checkTop(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogMaxSQLEditor.this.qim)) {
...
//                        return;
//                    }
//                    GBase8aAnalysisLogMaxSQLEditor.this.refreshTable(GBase8aAnalysisLogMaxSQLEditor.this.getMap_sql());
//                }
//            }
//        });
//
...
//            public void widgetSelected(SelectionEvent e) {
//                LogAnalysis.export(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogMaxSQLEditor.this.table.getColumns(), GBase8aAnalysisLogMaxSQLEditor.this.table.getItems());
//            }
//        });
//
...
//                TableItem[] items = GBase8aAnalysisLogMaxSQLEditor.this.table.getItems();
//                Point pt = new Point(e.x, e.y);
//                StringBuffer sb = new StringBuffer();
//                for (int i = 0; i < items.length; i++) {
//                    for (int j = 0; j < GBase8aAnalysisLogMaxSQLEditor.this.table.getColumnCount(); j++) {
...
//                                sb.append(itemtext);
//                            }
//                            GBase8aAnalysisLogMaxSQLEditor.this.table.setToolTipText(sb.toString());
//                        }
//                    }
//                }
//            }
...
//        public void run() {
//            try {
//                GBase8aAnalysisLogMaxSQLEditor.this.setMap_sql(LogAnalysis.getUserMaxResultSQL(GBase8aAnalysisLogMaxSQLEditor.this.qim));
...
//
//
///* Location:              /data/yolo/GBaseDataStudio_9.5.2.0_build21_Windows_x86_64/GBaseDataStudio/plugins/cn.gbase.studio.ext.gbase8a_1.0.0.jar!/cn/gbase/studio/ext/gbase8a/editors/GBase8aAnalysisLogMaxSQLEditor.class
