...
public class GBase8aCreateConsumerGroupDialog extends BaseDialog {
    private final GBase8aDataSource dataSource;
    private String name;
    private String comment;
    private final String vcName;

    public GBase8aCreateConsumerGroupDialog(Shell parentShell, GBase8aDataSource dataSource, String vcName) {
        super(parentShell, GBase8aMessages.dialog_create_Consumer_dialog_name, null);
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        nameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                GBase8aCreateConsumerGroupDialog.this.name = nameText.getText();
                GBase8aCreateConsumerGroupDialog.this.getButton(0).setEnabled(!GBase8aCreateConsumerGroupDialog.this.name.isEmpty());
            }
        });
        ...
        commentText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                GBase8aCreateConsumerGroupDialog.this.comment = commentText.getText();
            }
        });
