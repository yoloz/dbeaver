...
public class DelConsumerGroupHandler extends AbstractHandler {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (element instanceof DBNDatabaseItem) {
                ...
                if (!MessageDialog.openConfirm(
                        ...
                        GBase8aMessages.gbase8a_handlers_del_handler_confirm_consumergroup_message)) {
                    return null;
                }
                try (JDBCSession dbsession = DBUtils.openMetaSession(dataSource.getMonitor(), dataSource, "del consumer group");
                    ...
                    String delSql = "DROP consumer group ";
                    if (dataSource.isVCCluster()) {
                        delSql = delSql + vcName + ".";
                    }
                    delSql = delSql + groupName;
                    stmt.execute(delSql);
                } catch (Exception e) {
