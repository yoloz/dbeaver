...
public class DelResourcePoolHandler extends AbstractHandler {
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (element instanceof DBNDatabaseItem) {
                ...
                String name = ((DBNDatabaseNode) element).getName();
                ...
                if (!MessageDialog.openConfirm(
                        ...
                        GBase8aMessages.gbase8a_handlers_del_handler_confirm_resourcepool_message)) {
                    return null;
                }
                try (JDBCSession dbsession = DBUtils.openMetaSession(dataSource.getMonitor(), dataSource, "del resource pool");
                     JDBCStatement stmt = dbsession.createStatement()) {
                    String sql = "DROP resource pool ";
