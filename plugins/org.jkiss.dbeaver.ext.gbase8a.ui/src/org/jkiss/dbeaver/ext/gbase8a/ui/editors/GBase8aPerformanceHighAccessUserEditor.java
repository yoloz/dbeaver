...
//
//
//public class GBase8aPerformanceHighAccessUserEditor extends SinglePageDatabaseEditor<IDatabaseEditorInput> {
...
//                LogAnalysis.setConnection(GBase8aPerformanceHighAccessUserEditor.this.conn);
//                GBase8aPerformanceHighAccessUserEditor.this.qim = new QueryItemManager();
//                GBase8aPerformanceHighAccessUserEditor.this.qim.setStartTime(GBase8aPerformanceHighAccessUserEditor.this.cdtStartTime.getText());
//                GBase8aPerformanceHighAccessUserEditor.this.qim.setEndTime(GBase8aPerformanceHighAccessUserEditor.this.cdtEndTime.getText());
//                if (LogAnalysis.checkedDate(Display.getCurrent().getActiveShell(), GBase8aPerformanceHighAccessUserEditor.this.qim)) {
...
//                        return;
//                    }
//                    GBase8aPerformanceHighAccessUserEditor.this.refreshTable(GBase8aPerformanceHighAccessUserEditor.this.getMap_user());
//                }
//            }
//        });
//
...
//            public void widgetSelected(SelectionEvent e) {
//                LogAnalysis.export(Display.getCurrent().getActiveShell(), GBase8aPerformanceHighAccessUserEditor.this.table.getColumns(), GBase8aPerformanceHighAccessUserEditor.this.table.getItems());
//            }
//        });
//
...
//                TableItem[] items = GBase8aPerformanceHighAccessUserEditor.this.table.getItems();
//                Point pt = new Point(e.x, e.y);
//                StringBuffer sb = new StringBuffer();
//                for (int i = 0; i < items.length; i++) {
//                    for (int j = 0; j < GBase8aPerformanceHighAccessUserEditor.this.table.getColumnCount(); j++) {
...
//                                sb.append(itemtext);
//                            }
//                            GBase8aPerformanceHighAccessUserEditor.this.table.setToolTipText(sb.toString());
//                        }
//                    }
//                }
//            }
...
//        tblclmnSql.setWidth(227);
//        tblclmnSql.setText(GBase8aMessages.editors_performance_max_request_time);
//    }
//
//
...
//        public void run() {
//            try {
//                GBase8aPerformanceHighAccessUserEditor.this.setMap_user(LogAnalysis.getPerformanceHighAccessUser(GBase8aPerformanceHighAccessUserEditor.this.qim));
