...
public class ShowResourcePoolStatusOnNodesHandler extends AbstractHandler {
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            GBase8aShowResourcePoolStatusOnNodesDialog dialog = new GBase8aShowResourcePoolStatusOnNodesDialog(UIUtils.getActiveWorkbenchShell(), dataSource, false);
            ...
            if (dataSource.isVCCluster() && !"Default".equalsIgnoreCase(vcName)) {
                createSql = createSql + "status on nodes where resource_pool_name=? and vc_name=?";
            } else {
                createSql = createSql + "status on nodes where resource_pool_name=?";
            }
