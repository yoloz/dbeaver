...
public class GBase8aTriggerConfigurator implements DBEObjectConfigurator<GBase8aTrigger> {
    ...
    @Override
    public GBase8aTrigger configureObject(@NotNull DBRProgressMonitor monitor, @Nullable DBECommandContext commandContext,
                                          @Nullable Object parent, @NotNull GBase8aTrigger trigger, @NotNull Map<String, Object> options) {
        return UITask.run(() -> {
