...
public class GBase8aProcedureConfigurator implements DBEObjectConfigurator<GBase8aProcedure> {
    ...
    @Override
    public GBase8aProcedure configureObject(@NotNull DBRProgressMonitor monitor, @Nullable DBECommandContext commandContext,
                                            @Nullable Object parent, @NotNull GBase8aProcedure newProcedure, @NotNull Map<String, Object> options) {
        return UITask.run(() -> {
