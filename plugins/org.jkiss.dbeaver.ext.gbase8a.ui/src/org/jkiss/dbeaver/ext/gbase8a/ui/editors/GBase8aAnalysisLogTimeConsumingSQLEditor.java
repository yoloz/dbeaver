...
//
//
//public class GBase8aAnalysisLogTimeConsumingSQLEditor extends SinglePageDatabaseEditor<IDatabaseEditorInput> {
...
//                LogAnalysis.setConnection(GBase8aAnalysisLogTimeConsumingSQLEditor.this.conn);
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim = new QueryItemManager();
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim.setStartTime(GBase8aAnalysisLogTimeConsumingSQLEditor.this.cdtStartTime.getText());
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim.setEndTime(GBase8aAnalysisLogTimeConsumingSQLEditor.this.cdtEndTime.getText());
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim.setUserName(GBase8aAnalysisLogTimeConsumingSQLEditor.this.comboUser.getText());
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim.setTop(GBase8aAnalysisLogTimeConsumingSQLEditor.this.txtTop.getText());
//                if (LogAnalysis.checkedDate(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim) && LogAnalysis.checkTop(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim)) {
...
//                        return;
//                    }
//                    GBase8aAnalysisLogTimeConsumingSQLEditor.this.refreshTable(GBase8aAnalysisLogTimeConsumingSQLEditor.this.getMap_sql());
//                }
//            }
//        });
//
...
//            public void widgetSelected(SelectionEvent e) {
//                LogAnalysis.export(Display.getCurrent().getActiveShell(), GBase8aAnalysisLogTimeConsumingSQLEditor.this.table.getColumns(), GBase8aAnalysisLogTimeConsumingSQLEditor.this.table.getItems());
//            }
//        });
//
...
//                TableItem[] items = GBase8aAnalysisLogTimeConsumingSQLEditor.this.table.getItems();
//                Point pt = new Point(e.x, e.y);
//                StringBuffer sb = new StringBuffer();
//                for (int i = 0; i < items.length; i++) {
//                    for (int j = 0; j < GBase8aAnalysisLogTimeConsumingSQLEditor.this.table.getColumnCount(); j++) {
...
//                                sb.append(itemtext);
//                            }
//                            GBase8aAnalysisLogTimeConsumingSQLEditor.this.table.setToolTipText(sb.toString());
//                        }
//                    }
//                }
//            }
...
//        public void run() {
//            try {
//                GBase8aAnalysisLogTimeConsumingSQLEditor.this.setMap_sql(LogAnalysis.getUserLongTimeSQL(GBase8aAnalysisLogTimeConsumingSQLEditor.this.qim));
...
//
//
///* Location:              /data/yolo/GBaseDataStudio_9.5.2.0_build21_Windows_x86_64/GBaseDataStudio/plugins/cn.gbase.studio.ext.gbase8a_1.0.0.jar!/cn/gbase/studio/ext/gbase8a/editors/GBase8aAnalysisLogTimeConsumingSQLEditor.class
