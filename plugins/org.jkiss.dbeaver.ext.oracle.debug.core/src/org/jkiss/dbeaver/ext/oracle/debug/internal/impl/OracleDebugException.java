 ...
 * @author yolo
 */
public enum OracleDebugException {
    ...
    OracleDebugException(int code, String msg) {
        this.code = code;
        this.msg = msg;
    }
    ...
    public static String getMessage(int status) {
        Optional<OracleDebugException> breakpointStatus = Arrays.stream(OracleDebugException.values()).filter(b -> b.code == status).findFirst();
