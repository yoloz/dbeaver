 ...
 */
package org.jkiss.dbeaver.ext.gbase8a.sql;
...
* MySQL dialect rules
*/
class GBase8aDialectRules implements TPRuleProvider {
    ...
    public TPRule[] extendRules(@Nullable DBPDataSourceContainer dataSource, @NotNull RulePosition position) {
        if (position == RulePosition.CONTROL) {
            final SQLControlToken sourceToken = new SQLControlToken("gbase8a.source");
