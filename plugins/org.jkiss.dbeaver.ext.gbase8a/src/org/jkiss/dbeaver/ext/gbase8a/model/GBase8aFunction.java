...
//
//    private static final Log log = Log.getLog(GBase8aFunction.class);
//
...
//            log.debug("Unsupported function type: " + procType);
...
//    }
//
//    @Property(order = 3,name="resultType")
//    public String getResultType() {
//        return resultType;
//    }
//
//    @Property(order = 4,name="bodyType")
//    public String getBodyType() {
//        return bodyType;
//    }
//
//    @Property(editable = true, updatable = true, order = 5,name="deterministic")
...
//    @Nullable
//    @Override
//    public Collection<GBase8aFunctionParameter> getParameters(@NotNull DBRProgressMonitor monitor) throws DBException {
//        return getContainer().getFunctionsCache().getChildren(monitor, getContainer(), this);
//    }
//
//    @NotNull
//    @Override
...
//        return getContainer().getFunctionsCache().refreshObject(monitor, getContainer(), this);
//    }
//
//    @Override
