...
public class Gbase8aPlugin extends GBase8aInformation implements DBPStatefulObject {
    ...
    public Gbase8aPlugin(@NotNull GBase8aDataSource dataSource, @NotNull ResultSet dbResult) {
        super(dataSource);
